...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-11 items-center justify-center rounded-xl glass p-1 text-white/50",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.Trigger
    ...
    className={cn(
      ...
      "data-[state=active]:glass-gold data-[state=active]:text-gold-400 data-[state=active]:shadow-sm",
      "hover:text-white/80",
      className
    )}
    {...props}
